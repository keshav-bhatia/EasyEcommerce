...
// var categories = ["Tea", "Vegetables", "PersonalCare"];
var categories = ["Tea", "Coffee", "Decaf"];
...
$(document).ready(function(){
    ...
    for(var i = 0; i < categories.length; i++){
        var filterBodyStr = 
            '<div class="form-check">' +
                '<input class="form-check-input" type="radio" value="" name="radAnswer"' + categories[i] + '">' +
            ...
            '<div class="modal fade" id="filterModal" role="dialog">' +
                '<div class="modal-dialog">' +
                    ...
                    '<div class="modal-content">' +
                        '<div class="modal-header">' +
                            '<button type="button" class="close" data-dismiss="modal" id="closeButton">&times;</button>' +
                            '<h3 class="modal-title">Choose your category to show </h3>' +
                        '</div>' +

                        '<div class="modal-body">' +
                            filterList +
                            '</br></br><p><b>Price Range (Rupees)): </b></p>' +
                            ...
                            '<input class="price-range" type="number" id="maxPrice" name="maxPrice" value="5000">' +
                        '</div>' +
    ...
    $("body").on("click", ".apply-filter-btn", (function() {
        ...
        if(selMinPrice >= selMaxPrice){
        ...
        else if(selMaxPrice > 5000){
            alert("Max price must not exceed 5000");
        }
            ...
            //must use 'hasParam' parameter whenever a query string needs to be constructed - otherwise may
            //return improper pagination
            if((filterCategories.length == 0) && (filterMinPrice > 0 || filterMaxPrice < 5000)){
