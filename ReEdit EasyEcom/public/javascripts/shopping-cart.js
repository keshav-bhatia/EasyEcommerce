        ...
        '<div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Order summary </div></br>' +
            '<div class="p-4">' +
                '<ul class="list-unstyled mb-4">' +
                    '<li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Order Subtotal </strong><strong> Rs ' + precise_subTotal + '</strong></li>' +
                    '<li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Shipping and handling </strong><strong> Rs ' + shippingFee + '</strong></li>' +
                    '<li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tax </strong><strong> Rs  ' + tax + '</strong></li>' +
                    '<li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Grand Total </strong><strong> Rs ' + grandTotal + '</strong></li>' +
                '</ul>'+
                '</br>' +
